...
class FavoriteController extends Controller
{
    ...
    public function index($user_id): JsonResponse
    {
        ...
        return $this->sendResponse($user->favorites()->get(), 'Favorite resource list retrieved successfully.');
    }
    ...
    public function store($user_id, $resource_id): JsonResponse
    {
        ...
        if (!$user->favorites()->where('resource_id', $resource->id)->exists())
        {
            ...
            return $this->sendResponse($user->read_later()->get(), 'Resource add to favorites list successfully.');
        } else {
